...
namespace gem5
{
  ...
  namespace prefetch
  {
     ...
     */
    class TriageHashedSetAssociative : public TaggedSetAssociative
    {
    public:
    ...
    class Triage : public Queued
    {
      ...
      struct TrainingUnitEntry : public TaggedEntry
      {
        ...
        TrainingUnitEntry(TagExtractor ext)
            : TaggedEntry(), lastAddress(0), lastLastAddress(0), temporal(4, 8)
        {
      ...
      struct MarkovMapping : public TaggedEntry
      {
        ...
        MarkovMapping(TagExtractor ext)
            : TaggedEntry(), index(0), address(0), confident(false)
        {
          registerTagExtractor(ext);
        }
